...
export function MediaSetup() {
  ...
  return <div className="media-setup">
    <div className="drawer-intro"><p className="drawer-kicker">Source / 01</p><h2>Choose the scene.</h2><p>Use a sample or upload your own image. Choose a detector, set the confidence, and find what matters.</p></div>
